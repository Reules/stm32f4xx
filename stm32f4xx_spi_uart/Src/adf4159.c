...
void adf4159Init(void){
	...
	adf4159Spi1Tx(PLL_REG_R1_LSB_FRAC, (2538L << R1_SHIFT_LSB_FRACTIONAL_VALUE));			//Fraction LSB is 0/1638/6554
...
//										| (1792L << R0_SHIFT_MSB_FRACTIONAL_VALUE));
	...
	adf4159Spi1Tx(PLL_REG_R5_DEVIATION, (5479L << R5_SHIFT_DEVIATION_WORD)
